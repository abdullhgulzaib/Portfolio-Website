...
export default function SubmitButton({ isSubmitting }) {
  return (
    <div className="submit-btn-wrapper">
      <button 
        className={`animated-submit-btn ${isSubmitting ? 'is-active' : ''}`} 
        type="submit" 
      ...
      >
        ...
        <div className="state state--sent">
          <div className="icon">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="1em" width="1em" strokeWidth="0.5px" stroke="white">
              <g style={{filter: 'url(#shadow)'}}>
